...
class FeedMixVi(
    ...
    private val feedMixCallback: FeedMixCallBack,
        ...
        super.setWebViewClient(object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                if (url?.contains("ninecasino") == true) {
                    MainApplication.sleepingMInputMode =
    ...
    private fun eggLabelHandleCreateWebWindowRequest(resultMsg: Message?) {
        ...
        if (resultMsg.obj != null && resultMsg.obj is WebViewTransport) {
            ...
            val windowWebView = FeedMixVi(eggLabelContext, feedMixCallback, eggLabelWindow)
            transport.webView = windowWebView
            resultMsg.sendToTarget()
            feedMixCallback.feedMixHandleCreateWebWindowRequest(windowWebView)
        }
    }
